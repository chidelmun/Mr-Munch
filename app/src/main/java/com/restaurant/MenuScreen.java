...
public class MenuScreen extends ExpandableListActivity {
    ...
    public class MyExpandableListAdapter extends BaseExpandableListAdapter {
    	...
    	private String[] groups = { "Local Dishes", "Soups","Chinese", "Sandwiches", "Cold Drinks","Juice"};
        private String[][] children = {
                { "Fufu and Eru","Rice and Beans","Plantains and Ndole"},
                {"Tomato stew","Vegetable stew"},
                {"Chinese Rice","Shrimps"},
                {"Cheese","foods 2" },
                { "Guiness","Sprite","Malta" },
                { "Mango Juice","Orange Juice","Grap Juice","Apple Juice","Cocktail"}
